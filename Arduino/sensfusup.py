...
def control_bomba(temperatura):
    if 21 <= temperatura <= 25:
        ...
        lcd.clear()
        lcd.write_string("B On")
        print("Bomba encendida")
        time.sleep(5)
    else:
        GPIO.output(IN1, GPIO.LOW)
        lcd.clear()
        lcd.write_string("B Off")
        print("Bomba apagada")
        time.sleep(5)
...
def dht11_interior():
    while True:
        ...
        if lectura:
            ...
            print("Error al leer el sensor interior")
            time.sleep(5)
        time.sleep(5)
...
def sensor_humedad():
    ...
    while True:
        ...
        if estado == GPIO.HIGH:
            ...
            lcd.clear()
            lcd.write_string("Tier S")
            print("Tierra seca")
        else:
            datos_humedad_suelo.append("Húmeda")
            lcd.clear()
            lcd.write_string("Tier H")
            print("Tierra húmeda")
        time.sleep(5)
